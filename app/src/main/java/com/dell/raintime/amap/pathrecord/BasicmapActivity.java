package com.dell.raintime.amap.pathrecord;
...
import com.dell.raintime.amap.database.DbAdapter;
import com.dell.raintime.amap.record.PathRecord;
import com.dell.raintime.amap.recordutil.Util;
...
public class BasicmapActivity extends Activity implements LocationSource,
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (btn.isChecked()) {
					...
					mTraceClient.queryProcessedTrace(2, Util.parseTraceLocationList(record.getPathline()) , LBSTraceClient.TYPE_AMAP, BasicmapActivity.this);
	...
	protected void saveRecord(List<AMapLocation> list, String time) {
		if (list != null && list.size() > 0) {
			...
			Toast.makeText(BasicmapActivity.this, "没有记录到路径", Toast.LENGTH_SHORT)
					.show();
		}
	}
		...
		if (lineID == 1) {
			if (linepoints != null && linepoints.size()>0) {
				...
				if (mlocMarker == null) {
					...
					Toast.makeText(BasicmapActivity.this, "距离"+mDistance, Toast.LENGTH_SHORT).show();
