...
public class ViewPagerAdapter extends PagerAdapter implements DataSetSubject {
    ...
    private List<DataSetSubscriber> mSubscribers = new ArrayList<DataSetSubscriber>();
     ...
     */
    public ViewPagerAdapter(List<ImageView> mDataViews, OnPageClickListener listener) {
